...
ST Microerectronics製STM32マイコンを搭載したマイコンボードです。低価格であり、すぐにプロトタイプが作れます。ローパワーなボードからハイパフォーマンスなボートまで幅広くが豊富あるのが特徴です。Aruinoと同じコネクタとmorphoコネクタが搭載されているボードが用意されているモデルもあります。Necleoには、デバッカ・プログラマが搭載されており別途購入する必要がありません。HALライブラリが用意されておりすぐにアプリケーションが構築することができます。
